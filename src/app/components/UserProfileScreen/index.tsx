      ...
      <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center mt-6 -mx-2">
          <img
            ...
            src="https://images.unsplash.com/photo-1508153460964-48ffffcb0829?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="avatar"
          />
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            ...
            <a
              className="flex items-center px-4 py-2  mt-5 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200"
              href="#"
            >
              <svg
                className="w-5 h-5"
